...
run_config_wizard() {
    ...
    info ""
    info "【Step 2】抖音小店配置"
    read -p "抖店登录用户名 (手机号/邮箱): " dy_username
    read -s -p "抖店登录密码: " dy_password
    echo ""
...
# 抖音小店自动化上货快捷命令
alias dyshop='bash ~/.agents/skills/douyin-shop-automation/scripts/run.sh'
alias dyshop-collect='bash ~/.agents/skills/douyin-shop-automation/scripts/collect.sh'
alias dyshop-process='bash ~/.agents/skills/douyin-shop-automation/scripts/process.sh'
alias dyshop-upload='bash ~/.agents/skills/douyin-shop-automation/scripts/upload.sh'
alias dyshop-config='nano ~/.agents/skills/douyin-shop-automation/config/config.json'
alias dyshop-logs='tail -f ~/.agents/skills/douyin-shop-automation/logs/*.log'
EOF
